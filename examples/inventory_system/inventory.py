...
class InventorySystem:
    ...
    def get_movements(self, sku: str) -> list[Movement]:
        ...
        # BUG 1: Sorted by ID (arrival order) instead of timestamp (chronological)
        return sorted(sku_moves, key=lambda m: m.id)
    ...
    def calculate_stock(self, sku: str) -> StockLevel:
        ...
        # BUG 4: available doesn't subtract pending_outbound
    ...
    def needs_reorder(self, sku: str) -> bool:
        ...
        # BUG 3: Uses current_stock instead of available
        return stock.current_stock < self.reorder_point
